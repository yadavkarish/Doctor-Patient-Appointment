...
<div class="cal-icon">
<input type="text" class="form-control datetimepicker" name="dateOfBirth" value="${patient.getDateOfBirth()}">
</div>
</div>
</div>
<div class="col-12 col-md-6">
...
<input type="email" class="form-control" name="emailId" value="${patient.getEmailId()}">
</div>
</div>
<div class="col-12 col-md-6">
<div class="form-group">
<label>Mobile</label>
<input type="text"  name="mobile" class="form-control" value="${patient.getMobile()}">
</div>
</div>
<div class="col-12">
<div class="form-group">
...
<div class="form-group">
<label>State</label>
<input type="text" class="form-control" name="state" value="${patient.getState()}">
</div>
</div>
<div class="col-12 col-md-6">
<div class="form-group">
<label>Zip Code</label>
<input type="text" class="form-control" name="zipCode" value="${patient.getZipCode()}">
</div>
</div>
<div class="col-12 col-md-6">
<div class="form-group">
<label>Country</label>
<input type="text" class="form-control" name="country" value="${patient.getCountry()}">
</div>
</div>
</div>
