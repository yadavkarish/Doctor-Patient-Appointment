...
<!-- doccure/chat-doctor.jsp  30 Nov 2019 04:12:13 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
							...
							<div class="call-wrapper">
								<div class="call-inner">
									...
									<div class="call-items">
										...
										<a href="voice-call.jsp" class="btn call-item call-start"><i class="material-icons">call</i></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="call-box incoming-box">
							<div class="call-wrapper">
								<div class="call-inner">
									...
									<div class="call-items">
										<a href="javascript:void(0);" class="btn call-item call-end" data-dismiss="modal" aria-label="Close"><i class="material-icons">call_end</i></a>
										<a href="video-call.jsp" class="btn call-item call-start"><i class="material-icons">videocam</i></a>
									</div>
								</div>
							</div>
						</div>
...
<!-- doccure/chat-doctor.jsp  30 Nov 2019 04:12:14 GMT -->
</html>